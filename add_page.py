...
def add_page(html_file, page_title):
...
if __name__ == '__main__':
    if len(sys.argv) != 3:
        print("Usage: python add_page.py <html_filename> <page_title>")
        print("Example: python add_page.py session_6_recap.html 'Session 6'")
        sys.exit(1)
    
    add_page(sys.argv[1], sys.argv[2])
